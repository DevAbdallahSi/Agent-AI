...
const VisualLearning: React.FC = () => {
  ...
  const currentVisualizations = visualizations[selectedTopic as keyof typeof visualizations] || []
          ...
          {topics.map((topic) => (
            ...
            >
              <div className="text-center">
                <div className="inline-flex p-3 rounded-full bg-primary-100 dark:bg-primary-900/20 mb-3">
                  <topic.icon className="h-6 w-6 text-primary-600 dark:text-primary-400" />
                </div>
            ...
            <div className="flex justify-center mb-6">
              <div className="flex space-x-2">
                {[42, 17, 93, 28, 55].map((value, index) => (
                  ...
                  >
                    <div className="w-16 h-16 bg-primary-500 text-white rounded-lg flex items-center justify-center font-bold text-lg hover:bg-primary-600 transition-colors">
                      {value}
                    </div>
