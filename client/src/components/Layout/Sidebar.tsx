  ...
  return (
    <>
      ...
      <div className={`
        ...
        transform transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto lg:top-16
      ...
      `}>
        ...
        <nav className="mt-4 px-4 space-y-2 h-full overflow-y-auto pb-20">
          {menuItems.map((item) => (
            <NavLink
              key={item.path}
              to={item.path}
