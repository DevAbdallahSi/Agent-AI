...
export const getAlgorithm = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    ...
    // Check if user has completed this algorithm
    ...
    res.json(algorithmWithProgress)
  } catch (error) {
    next(error)
  }
}
